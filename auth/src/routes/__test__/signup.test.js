...
it("returns a 201 on a successful response", () => __awaiter(void 0, void 0, void 0, function* () {
...
it("returns a 400 with a password less than 4 characters", () => __awaiter(void 0, void 0, void 0, function* () {
    return (0, supertest_1.default)(app_1.app)
        .post("/api/users/signup")
        .send({
        email: "test@example.com",
...
it("returns a 400 with missing email and password", () => __awaiter(void 0, void 0, void 0, function* () {
    return (0, supertest_1.default)(app_1.app).post("/api/users/signup").send({}).expect(400);
}));
...
it('sets a cookie after a successful login', () => __awaiter(void 0, void 0, void 0, function* () {
